...
import { handleOrderCreated } from '../events/handlers/orderCreated.js';
...
// @route   POST /api/consume/order-created
// @access  Public
export const consumeOrderCreatedMessage = async (req, res) => {
  try {
